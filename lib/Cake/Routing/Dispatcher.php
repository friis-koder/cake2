...
class Dispatcher implements CakeEventListener
{
     ...
     *
     * @throws MissingControllerException|ReflectionException When the controller is missing.
     ...
     */
    public function dispatch(CakeRequest $request, CakeResponse $response, $additionalParams = array()): ?string
    {
        $beforeEvent = new CakeEvent(
            'Dispatcher.beforeDispatch',
            $this,
            compact('request', 'response', 'additionalParams')
        );
        ...
        if (!($controller instanceof Controller)) {
            throw new MissingControllerException(
                array(
                    ...
                    'plugin' => empty($request->params['plugin']) ? null : Inflector::camelize(
     ...
     */
    protected function _invoke(Controller $controller, CakeRequest $request): CakeResponse
    {
     ...
     */
    protected function _getController(CakeRequest $request, CakeResponse $response)
    {
     ...
     */
    protected function _loadController(CakeRequest $request)
    {
