...
abstract class BaseCoverageReport
{
     ...
     */
    protected function _calculateCoveredLines(array $fileLines, array $coverageData): array
    {
        $covered = $total = 0;
     ...
     */
    abstract public function generateDiff(string $filename, array $fileLines, array $coverageData): string;
}
