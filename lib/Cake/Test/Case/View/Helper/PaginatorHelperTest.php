...
class PaginatorHelperTest extends CakeTestCase
{
    ...
    public function testSortLinksMultiplePagination()
    {
        ...
        $result = $this->Paginator->sort('title');
        $expected = [
            'a' => ['href' => '/accounts/index/article%5Bsort%5D:title/article%5Bdirection%5D:asc/article%5Border%5D:', 'model' => 'Articles'],
            'Title',
            '/a'
        ];
        $this->assertTags($result, $expected);
    ...
    public function testUrlMultiplePagination()
    {
        ...
        $expected = [
            'span' => ['class' => 'next'],
            'a'    => ['href' => '/posts/index/article%5Bpage%5D:4', 'rel' => 'next', 'model' => 'Article'],
            'next',
            '/a',
            '/span'
        ];
        ...
        $expected = [
            'span' => ['class' => 'prev'],
            'a'    => ['href' => '/posts/index/article%5Bpage%5D:2', 'rel' => 'prev', 'model' => 'Article'],
            'prev',
            '/a',
            '/span'
        ];
        $this->assertTags($result, $expected);
        $result = $this->Paginator->url(['sort' => 'name']);
