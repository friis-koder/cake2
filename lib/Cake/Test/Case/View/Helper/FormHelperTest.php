...
class Contact extends CakeTestModel
{
    ...
    protected $_schema = [
        ...
        'lap_time'  => ['type' => 'time', 'null' => '', 'default' => '', 'length' => '2'],
        'last_seen' => ['type' => 'datetime', 'null' => '', 'default' => '', 'length' => '3'],
...
class FormHelperTest extends CakeTestCase
{
    ...
    public function testFormSecurityInputUnlockedFieldsDebugSecurityTrue()
    {
        ...
        $result = $this->Form->secure($expected, ['debugSecurity' => true]);
    ...
    public function testFormSecurityInputUnlockedFieldsDebugSecurityFalse()
    {
        ...
        $result = $this->Form->secure($expected, ['debugSecurity' => false]);
    ...
    public function testUnlockMultipleFieldRemovingFromFields()
    {
        ...
        $this->Form->hidden('Order.id', ['value' => 1]);
    ...
    public function testPasswordValidationWithOptions()
    {
        ...
        $result = $this->Form->input('Contact.password', [
            'error' => [
                'attributes' => ['class' => 'special-error-class'],
            ]
        ]);
        $expected = [
            'div'   => ['class' => 'input password error'],
        ...
        $Contact->validationErrors['password'] = ['Please provide a password<br>otherwise you will not be able to login'];
        $result = $this->Form->input('Contact.password', [
            'error' => [
                'attributes' => [
    ...
    public function testFormValidationAssociated()
    {
        ...
        $result = $this->Form->error(
            'OpenidUrl.openid_not_registered',
    ...
    public function testRadioHiddenFieldValue()
    {
        ...
        $expected = [
            'div'    => ['class' => 'input radio'],
            ['input' => ['type' => 'hidden', 'name' => 'data[Model][1][field]', 'value' => 'N', 'id' => 'Model1Field_']],
            ['input' => ['type' => 'radio', 'name' => 'data[Model][1][field]', 'value' => '0', 'id' => 'Model1Field0']],
            'label'  => ['for' => 'Model1Field0'],
            'option A',
            '/label',
    ...
    public function testSelectOptionGroupWithNumericLabel()
    {
        ...
        $expected = [
            'select'    => ['name' => 'data[Model][field]', 'id' => 'ModelField'],
            ['optgroup' => ['label' => '1']],
            ['option'   => ['value' => '1']], '1Foo', '/option',
            ['option'   => ['value' => '2']], '2Bar', '/option',
            ['option'   => ['value' => '3']], '3Baz', '/option',
            ['option'   => ['value' => '6']], '3', '/option',
            ['option'   => ['value' => '9']], '3', '/option',
            '/optgroup',
            ['optgroup' => ['label' => '2']],
            ['option'   => ['value' => '11']], '1Foo', '/option',
            ['option'   => ['value' => '12']], '2Bar', '/option',
            ['option'   => ['value' => '13']], '3Baz', '/option',
    ...
    public function testSelectMultiple()
    {
        ...
        $result = $this->Form->select(
            'Model.multi_field',
            $options,
            ['form' => 'my-form', 'multiple' => 'multiple']
        );
        $expected = [
            'input' => [
                'type' => 'hidden', 'name' => 'data[Model][multi_field]', 'value' => '', 'id' => 'ModelMultiField_',
    ...
    public function testSecurePostButton()
    {
        ...
        $expected = [
            ...
            ['div'   => ['style' => 'display:none;']],
            ['input' => ['type' => 'hidden', 'name' => '_method', 'value' => 'POST']],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][key]', 'value' => 'testkey', 'id' => 'preg:/Token\d+/', 'autocomplete']],
            '/div',
            'button' => ['type' => 'submit'],
            'Delete',
            '/button',
            ['div'   => ['style' => 'display:none;']],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][fields]', 'value' => 'preg:/[\w\d%]+/', 'id' => 'preg:/TokenFields\d+/', 'autocomplete']],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][unlocked]', 'value' => '', 'id' => 'preg:/TokenUnlocked\d+/', 'autocomplete']],
            ['input' => [
                'type'  => 'hidden', 'name' => 'data[_Token][debug]',
                'value' => $tokenDebug, 'id' => 'preg:/TokenDebug\d+/',
            ]],
    ...
    public function testPostLinkSecurityHash()
    {
        ...
        $this->assertTags($result, [
            ...
            ['input' => ['type' => 'hidden', 'name' => '_method', 'value' => 'POST']],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][key]', 'value' => 'test', 'id', 'autocomplete']],
            'div'    => ['style' => 'display:none;'],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][fields]', 'value' => $hash, 'id', 'autocomplete']],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][unlocked]', 'value' => '', 'id', 'autocomplete']],
            ['input' => [
                'type'  => 'hidden', 'name' => 'data[_Token][debug]',
                'value' => $tokenDebug, 'id' => 'preg:/TokenDebug\d+/',
            ]],
    ...
    public function testPostLinkAfterGetForm()
    {
        ...
        $this->assertTags($result, [
            ...
            ['input' => ['type' => 'hidden', 'name' => '_method', 'value' => 'POST']],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][key]', 'value' => 'testkey', 'id' => 'preg:/Token\d+/', 'autocomplete' => 'off']],
            'div'    => ['style' => 'display:none;'],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][fields]', 'value' => 'preg:/[\w\d%]+/', 'id' => 'preg:/TokenFields\d+/', 'autocomplete']],
            ['input' => ['type' => 'hidden', 'name' => 'data[_Token][unlocked]', 'value' => '', 'id' => 'preg:/TokenUnlocked\d+/', 'autocomplete']],
            ['input' => [
    ...
    public function testSubmitButton()
    {
        ...
        $result = $this->Form->submit('Test', ['confirm' => 'Confirm?']);
        $expected = [
            'div'   => ['class' => 'submit'],
            'input' => [
    ...
    public function testSubmitImage()
    {
        ...
        $result = $this->Form->submit('cake.power.gif', ['confirm' => 'Confirm?']);
        $expected = [
            'div'   => ['class' => 'submit'],
            'input' => [
    ...
    public function testInputErrorClass()
    {
        ...
        $result = $this->Form->input('Contact.field', [
            'type' => 'text',
            'div'  => ['errorClass' => 'has-error']
        ]);
        $expected = [
            'div'   => ['class' => 'input text has-error'],
            'label' => ['for' => 'ContactField'],
            'Field',
            '/label',
            'input' => [
        ...
        $result = $this->Form->input('Contact.field', [
            'type'  => 'text',
            'div'   => ['errorClass' => 'has-error'],
            'error' => ['attributes' => ['class' => 'form-control-feedback']]
        ]);
        $expected = [
            'div'   => ['class' => 'input text has-error'],
            'label' => ['for' => 'ContactField'],
