...
class HtmlHelperTest extends CakeTestCase
{
    ...
    public function testLink()
    {
        ...
        $result = $this->Html->link('<[You]>', array('action' => 'login', '<[You]>'));
        $expected = array(
    ...
    public function testImageQueryString()
    {
        ...
        $this->assertTags(
            $result,
            array('img' => array('src' => '/images/display/test?one=two&amp;three=four', 'alt' => ''))
        );
    }
    ...
    public function testImagePathPrefix()
    {
        ...
        $this->assertTags(
            $result,
            array('img' => array('src' => 'https://cakephp.org/assets/img/test.gif', 'alt' => ''))
        );
    ...
    public function testScriptTimestamping()
    {
        ...
        $this->assertRegExp(
            '/__cake_js_test.js\?' . $timestamp . '[0-9]{2}"/',
            $result,
            'Timestamp value not found %s'
        );
    ...
    public function testPluginScriptTimestamping()
    {
        ...
        $this->skipIf(
            !is_writable($pluginJsPath),
            $pluginJsPath . ' is not Writable, timestamp testing has been skipped.'
        );
        ...
        $this->assertRegExp(
            '/test_plugin\/js\/__cake_js_test.js\?' . $timestamp . '[0-9]{2}"/',
            $result,
            'Timestamp value not found %s'
        );
    ...
    public function testGetCrumbFirstLink()
    {
        ...
        $result = $this->Html->getCrumbs(
            ' - ',
            array('url' => '/home', 'text' => '<img src="/home.png" />', 'escape' => false)
        );
        $expected = array(
    ...
    public function testMeta()
    {
        ...
        $result = $this->Html->meta(
            'rss',
            array('controller' => 'posts', 'ext' => 'rss'),
        ...
        $result = $this->Html->meta(
            'atom',
            array('controller' => 'posts', 'ext' => 'xml'),
        ...
        $this->assertTags(
            $result,
            array('meta' => array('name' => 'keywords', 'content' => 'these, are, some, meta, keywords'))
        );
    ...
    public function testTableHeaders()
    {
        ...
        $result = $this->Html->tableHeaders(
            array('ID', array('Name' => array('class' => 'highlight', 'width' => '120px')), 'Date')
        );
        $expected = array(
            '<tr',
            '<th',
    ...
    public function testTableCells()
    {
        ...
        $expected = array(
            ...
            'td content 2',
            '/td',
            array('td' => array('class' => 'foo column-3')),
            'td content 3',
            '/td',
            '/tr'
        );
