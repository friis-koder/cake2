...
class HtmlHelperTest extends CakeTestCase
{
    ...
    public function testImagePathPrefix()
    {
        ...
        $result = $this->Html->image('test.gif', ['pathPrefix' => 'https://cakephp.org/assets/img/']);
        $this->assertTags($result, ['img' => ['src' => 'https://cakephp.org/assets/img/test.gif', 'alt' => '']]);
    ...
    public function testBase64ImageTag()
    {
        ...
        $result = $this->Html->image('cake.icon.png', ['base64' => true]);
        $this->assertTags($result, [
            'img' => [
        ...
        $result = $this->Html->image('/img/cake.icon.png', ['base64' => true]);
        $this->assertTags($result, [
            'img' => [
                'src' => 'preg:/data:image\/png;base64,(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=|[A-Za-z0-9+\/]{4})/',
                'alt' => ''
    ...
    {
        $this->Html->request->webroot = '';
        $this->Html->image('non-existent-image.png', ['base64' => true]);
    }
    ...
    public function testCssLink()
    {
        ...
        $result = $this->Html->css('cake.generic', ['pathPrefix' => 'https://cakephp.org/assets/css/']);
    ...
    public function testScript()
    {
        ...
        $result = $this->Html->script('foo3', ['pathPrefix' => 'https://cakephp.org/assets/js/']);
        $expected = [
            'script' => ['type' => 'text/javascript', 'src' => 'https://cakephp.org/assets/js/foo3.js']
        ];
        $this->assertTags($result, $expected);
    ...
    public function testBreadcrumb()
    {
        ...
        $this->Html->addCrumb('Zeroth', '#zeroth', ['prepend' => true]);
