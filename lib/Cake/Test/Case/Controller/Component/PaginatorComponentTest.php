...
class PaginatorComponentTest extends CakeTestCase
{
    ...
    public function testPaginate()
    {
        ...
        $Controller->Paginator->settings = [
            'order' => ['PaginatorControllerComment.id DESC']
        ];
        $results = Hash::extract($Controller->Paginator->paginate('PaginatorControllerComment'), '{n}.PaginatorControllerComment.id');
        $this->assertEquals([6, 5, 4, 3, 2, 1], $results);
    ...
    public function testPaginateNotCondition()
    {
        ...
        $Controller->Paginator->settings = [
            'conditions' => [
                'NOT' => ['PaginatorAuthor.user' => 'mariano'],
            ],
        ];
    ...
    public function testPaginateI18nConditionUser()
    {
        ...
        $Controller->uses = ['TranslatedArticle'];
        $Controller->constructClasses();
    ...
    public function testMergeOptionsModelSpecific()
    {
        ...
        $expected = ['page' => 1, 'limit' => 10, 'paramType' => 'named', 'maxLimit' => 50, 'queryScope' => null];
    ...
    public function testMergeOptionsNamedParams()
    {
        ...
        $result = $this->Paginator->mergeOptions('Post');
        $expected = ['page' => 10, 'limit' => 10, 'maxLimit' => 100, 'paramType' => 'named', 'queryScope' => null];
        $this->assertEquals($expected, $result);
    }
    ...
    public function testMergeOptionsMaxLimit()
    {
        ...
        $result = $this->Paginator->mergeOptions('Post');
        $expected = ['page' => 1, 'limit' => 200, 'maxLimit' => 100, 'paramType' => 'named', 'queryScope' => null];
        $this->assertEquals($expected, $result);
        ...
        $result = $this->Paginator->mergeOptions('Post');
        $expected = ['page' => 1, 'limit' => 20, 'maxLimit' => 10, 'paramType' => 'named', 'queryScope' => null];
        $this->assertEquals($expected, $result);
        ...
        $result = $this->Paginator->mergeOptions('Post');
        $expected = ['page' => 1, 'limit' => 500, 'maxLimit' => 100, 'paramType' => 'named', 'queryScope' => null];
        $this->assertEquals($expected, $result);
    }
